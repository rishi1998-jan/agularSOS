...
class CollegeCtl(BaseCtl):
    ...
    def request_to_form(self, requestForm):
        print("ors college request to form is run")
    ...
    def model_to_form(self, obj):
        if (obj == None):
            return
        print("ors college model to form is run")   
        self.form["id"] = obj.id
    ...
    def form_to_model(self, obj):
        ...
        if (pk > 0):
            obj.id= pk
        print("ors college form to model is run")    
    ...
    def display(self, request, params={}):
        print("ors college display is run")
        if (params["id"] > 0):
    ...
    def submit(self, request, params={}):
        print("ors college submit is run")
